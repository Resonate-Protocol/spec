...
- `supported_pair_methods`: object - pairing methods this client currently offers, keyed by method identifier, each value a [pair-method descriptor](pairing.md#client--server-clienthello-pair-method-descriptor). Every client implements at least the Pairing PSK method (see [Pairing](pairing.md#pairing)).
...
|---|---|
| [long-term PSK](README.md#definitions) | `[]`, `['playback']`, or `['pairing']` |
