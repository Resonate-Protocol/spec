...
- **Sendspin Pairing Code** - a decimal-digit value used in code-based [pairing](pairing.md#pairing) methods. The static-pairing-code method uses a fixed 8-digit value; the dynamic-pairing-code method uses a 6-digit value generated per pairing session (see [Dynamic Pairing Code Flow](pairing.md#dynamic-pairing-code-flow)).
