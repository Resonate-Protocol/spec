...
- If the session is [unpaired](#definitions), there is no record to remove (e.g., an in-flight pairing handshake keyed by the pairing PSK), so ignore the message and continue unchanged.
